...
const TripDetails = () => {
  ...
  if (!trip) {
    return (
      <div className="p-8 text-center text-red-500 mt-25">
          ...
          <table className="w-full text-center border-collapse">
            ...
            <tbody>
              <tr className="bg-gray-50 border-b">
                ...
                <td className="py-2 px-4">₹{trip.multiPrice.quad}/-</td>
              </tr>
              <tr className="bg-white border-b">
                <td className="py-2 px-4">Triple Sharing</td>
                <td className="py-2 px-4">₹{trip.multiPrice.triple}/-</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="py-2 px-4">Twin Sharing</td>
                <td className="py-2 px-4">₹{trip.multiPrice.twin}/-</td>
              </tr>
            </tbody>
          </table>
        </div>
